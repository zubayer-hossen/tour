...
// Generate PDF
    ...
    doc.fontSize(20).text(`"Unveil the Wonders, Embrace the Adventure – Your Dream Journey Begins Here!" `, { align: 'center' });
    doc.end();
    ...
    const adminMailOptions = {
      ...
      subject: '🎉 New Registration Alert - Special Economics Care Coaching Centre',
       html: `
    <div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; border-radius: 10px; padding: 20px; background-color: #ffffff; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
      ...
      <div style="padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
          ...
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd; background-color: #f8f9fa;"><strong>📞 Phone:</strong></td>
            <td style="padding: 10px; border: 1px solid #ddd;">${phone}</td>
          </tr>
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd; background-color: #f8f9fa;"><strong>👕 T-Shirt Size:</strong></td>
            <td style="padding: 10px; border: 1px solid #ddd;">${tshirtSize}</td>
          </tr>
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd; background-color: #f8f9fa;"><strong>💰 Fee Status:</strong></td>
        ...
        <!-- Gallery Section -->
        <h3 style="text-align: center; color: #0056b3; margin-top: 30px;">🌍 Adventure Awaits! Explore Our Tour Destinations!</h3>
...
<div style="border-top: 2px solid #007bff; padding: 25px; margin-top: 30px; text-align: center; background: linear-gradient(135deg, #f8f9fa, #ffffff); box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.15); border-radius: 10px;">
  ...
  <div style="margin-top: 12px; font-size: 15px; color: #333;">
    📞 <a href="tel:+8801580856397" style="color: #007bff; text-decoration: none; font-weight: bold;">+8801580856397</a> &nbsp; | &nbsp;
    ✉ <a href="mailto:fzhossen143r@gmail.com" style="color: #007bff; text-decoration: none; font-weight: bold;">fzhossen143r@gmail.com</a>
  </div>
      ...
      <div style="background: #f8f9fa; color: #333; text-align: center; padding: 15px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 14px;">
        <p style="margin: 5px 0; font-size: 16px;"><strong>📍 Special Economics Care Coaching Centre</strong></p>
        <p style="margin: 5px 0;">📞 Contact: <strong>01906-354505 (Shahadat Hossain)</strong> | <strong>01925-551630 (Abdullah Al Mamun)</strong></p>
        <p style="margin: 5px 0; font-size: 16px; font-weight: bold;">✨ "Unveil the Wonders, Embrace the Adventure – Your Dream Journey Begins Here!" ✨</p>
      </div>
  ...
  `,
    ...
    const userMailOptions = {
      from: process.env.EMAIL,
      to: email,
      subject: '🎟 Your Tour Registration is Confirmed!',
  ...
  <div style="padding: 25px; text-align: center;">
    <h2 style="color: #ff758c; font-size: 22px; margin-bottom: 10px;">🚀 Welcome Aboard!</h2>
    <p style="font-size: 16px; color: #444;">You’re about to embark on an incredible journey with us. Get ready to explore, learn, and create unforgettable memories! Your registration details are below:</p>
  </div>
  ...
  <div style="background: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr><td style="padding: 10px;"><strong>📞 Phone:</strong></td><td>${phone}</td></tr>
      <tr><td style="padding: 10px;"><strong>👕 T-Shirt Size:</strong></td><td>${tshirtSize}</td></tr>
      <tr><td style="padding: 10px;"><strong>💰 Fee Status:</strong></td><td style="color: ${feeStatus === 'Paid' ? 'green' : 'red'};"><strong>${feeStatus}</strong></td></tr>
    </table>
  </div>
  ...
  <div style="margin-top: 30px; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
    <h2 style="text-align: center; color: #ff758c;">📸 Tour Highlights</h2>
  ...
  <div style="background: #f8f9fa; text-align: center; padding: 15px; border-radius: 0 0 12px 12px; margin-top: 20px;">
    <p><strong>📍 Special Economic Care Coaching Centre</strong></p>
    <p>📞 Contact: <strong>01906-354505</strong> | <strong>01925-551630</strong></p>
  </div>
